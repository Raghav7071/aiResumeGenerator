...
const Feature = () => {
    ...
    return (
        ...
        <Title title='Build your resume ' description='Create a professional resume in just a few clicks with our AI-powered builder.'/>


            <div className="flex flex-col md:flex-row items-center justify-center x1:-top-10">
